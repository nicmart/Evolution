...
import evolution.app.react.component.{EvolutionContextComponent, EvolutionContextComponentProps}
...
sealed trait Drawing[T] {
    ...
    def contextElement(callback: Drawing[T] => Callback): VdomElement = {
        contextComponent.component(EvolutionContextComponentProps(
            context,
