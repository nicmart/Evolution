...
import evolution.compiler.phases.{ExprBasedFullCompiler, ExprModule}
...
final class ExprBasedCodeCompiler(fullCompiler: ExprBasedFullCompiler) extends CodeCompiler {
