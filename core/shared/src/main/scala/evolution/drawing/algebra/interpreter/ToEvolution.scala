...
object ToEvolution extends DrawingAlgebra[CtxEvolution] {
  ...
  override def mul[E, T: Type](k: CtxEvolution[E, Double], t: CtxEvolution[E, T]): CtxEvolution[E, T] = {
    ...
    Type[T].foldF[CtxEvolution[E, ?], CtxEvolution[E, ?]](t)(mulDouble[E](k), mulPoint[E](k))
  }
  ...
  override def inverse[E, T: Type](a: CtxEvolution[E, T]): CtxEvolution[E, T] = { e =>
    implicit val group: Group[T] = Type.group[T]
    a(e) match {
  ...
  /**
    ...
    */
  override def rnd[E](
    from: E => StaticOrDynamicEvolution[Double],
    to: E => StaticOrDynamicEvolution[Double]
  ): E => StaticOrDynamicEvolution[Double] =
    e =>
      (from(e), to(e)) match {
  ...
  override def point[E](
    x: E => StaticOrDynamicEvolution[Double],
    y: E => StaticOrDynamicEvolution[Double]
  ): E => StaticOrDynamicEvolution[Point] =
    e =>
      (x(e), y(e)) match {
  ...
  override def polar[E](
    r: E => StaticOrDynamicEvolution[Double],
    w: E => StaticOrDynamicEvolution[Double]
  ): E => StaticOrDynamicEvolution[Point] =
    e =>
      Dynamic(new Evolution[Point] {
        override def run[Evo[+ _]](implicit alg: algebra.FullAlgebra[Evo]): Evo[Point] =
  ...
  override def let[E, In, Out](name: String, value: CtxEvolution[E, In])(
    expr: CtxEvolution[(CtxEvolution[E, In], E), Out]
  ): E => StaticOrDynamicEvolution[Out] =
    ctx => expr((value, ctx))
  ...
  override def choose[E, T: Type](
    p: CtxEvolution[E, Double],
    drawing1: CtxEvolution[E, T],
    drawing2: CtxEvolution[E, T]
  ): CtxEvolution[E, T] = { ctx =>
    Dynamic(new Evolution[T] {
      override def run[Evo[+ _]](implicit alg: algebra.FullAlgebra[Evo]): Evo[T] =
  ...
  override def dist[E](
    p: CtxEvolution[E, Double],
    length1: CtxEvolution[E, Double],
    length2: CtxEvolution[E, Double]
  ): CtxEvolution[E, Double] =
    ctx =>
      Dynamic(new Evolution[Double] {
        override def run[Evo[+ _]](implicit alg: algebra.FullAlgebra[Evo]): Evo[Double] =
